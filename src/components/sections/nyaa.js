...
import { nyaaTorrent, shownTorrent } from "../../../config"
...
const Nyaa = () => {
  const MAX_ARTICLES = shownTorrent
  ...
  useEffect(() => {
    const loadArticles = async () => {
      if (isIntroDone) {
        ...
        fetch(nyaaTorrent, { headers: { Accept: "application/json" } })
  ...
  return (
    ...
    >
      <StyledContentWrapper>
        <h3 className="section-title">Spoilers & Evaluations</h3>
